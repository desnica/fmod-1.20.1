...
public class ModItems {
    ...
    public static final Item KNIFE = registerItem("knife",
            new SwordItem(SteelMaterial.STEEL_MATERIAL, 2, -1.5F, new FabricItemSettings().maxCount(1)));

    public static final Item POISONED_KNIFE = registerItem("poisoned_knife",
            new PoisonedKnifeItem(SteelMaterial.STEEL_MATERIAL, 2, -1.3F, new FabricItemSettings().maxCount(1)));

    public static final Item WITHERED_KNIFE = registerItem("withered_knife",
            new WitheredKnifeItem(SteelMaterial.STEEL_MATERIAL, 3, -1.0F, new FabricItemSettings().maxCount(1)));
    ...
    public static final Item SLAG = registerItem("slag", new BoneMealItem(new FabricItemSettings()));
