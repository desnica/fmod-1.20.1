...
import net.desnica.fmod.block.entity.BFurnaceBlockEntity;
...
public class BFurnaceScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final BFurnaceBlockEntity blockEntity;

    public BFurnaceScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
